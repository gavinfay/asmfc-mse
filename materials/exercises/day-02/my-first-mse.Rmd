---
title: "ASMFC MSE Workshop: First MSE"
author: "Gavin Fay"
date: "August 2021"
output: pdf_document
---
...
_(If you do not have these packages installed then run the currently commented out lines that call 'install.packages()')_  
```{r, results='hide'}
...
stat_summary(fun.data = "median_hilow", geom = "smooth", col="black",
       ...
       stat_summary(fun = median, fun.min = function(x)0, geom="line",
                    data = subset(project.results, type != "index" &  year %in% data.years), lwd=1) +facet_wrap(~type, scale = "free_y") + ylab("Million tonnes") + theme_bw()
